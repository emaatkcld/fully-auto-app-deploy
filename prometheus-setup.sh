...
sudo git clone -b instalations https://github.com/emaatkcld/fully-auto-app-deploy.git /tmp/fully-auto-app-deploy
sudo cp /tmp/fully-auto-app-deploy/prometheus-setup-dependencies/prometheus.yml /etc/prometheus/
sudo cp /tmp/fully-auto-app-deploy/prometheus-setup-dependencies/prometheus.service /etc/systemd/system/prometheus.service
